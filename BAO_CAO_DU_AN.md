# BÁO CÁO CHI TIẾT DỰ ÁN FLOODGUARD HƯƠNG KHÊ

## 1. Tổng quan dự án

FloodGuard Hương Khê là một hệ thống web hỗ trợ cảnh báo lũ lụt, tiếp nhận yêu cầu cứu hộ, điều phối đội cứu hộ và quản lý thông tin an toàn cho người dân tại khu vực Hương Khê, Hà Tĩnh. Dự án được xây dựng theo hướng mô phỏng nghiệp vụ thực tế: người dân có thể đăng ký nhận cảnh báo, gửi yêu cầu cứu hộ hoặc SOS khẩn cấp; lực lượng cứu hộ có giao diện theo dõi nhiệm vụ; quản trị viên có trung tâm điều phối, bản đồ, báo cáo, SMS và các công cụ quản lý dữ liệu.
...
- Cảnh báo lũ, triều cường, sạt lở và tình huống khẩn cấp.
...
Các nhóm dữ liệu chính trong `mockData.js` gồm khu vực hành chính, tài khoản demo, hồ sơ công dân, hộ dễ tổn thương, đội cứu hộ, cảnh báo lũ, yêu cầu cứu hộ, nhiệm vụ cứu hộ, điểm sơ tán, tuyến cứu hộ, đập/hồ chứa, SMS, báo cáo thiệt hại, nhật ký hoạt động và thông báo.
